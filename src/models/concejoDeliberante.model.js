...
function mapConcejoDeliberanteRow(row) {
  ...
  return {
    ...
    commissionsSchedule: row.commissions_schedule || '',
...
export async function upsertConcejoDeliberanteContentRow(payload) {
  await pool.query(
    ...
    ON DUPLICATE KEY UPDATE
      ...
      commissions_schedule = VALUES(commissions_schedule),
      contact_section_title = VALUES(contact_section_title),
      contact_section_subtitle = VALUES(contact_section_subtitle),
    ...
    [
      ...
      payload.commissionsSchedule,
      payload.contactSectionTitle,
      payload.contactSectionSubtitle,
